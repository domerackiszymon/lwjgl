...
import com.domer.core.entity.Model;
import com.domer.core.utils.Utils;
...
public class ObjectLoader {
    ...
    public Model loadModel(float[] vertices, int[] indices){
        ...
        storeDataIntoAttribList(0, 3, vertices);
        unbind();
    ...
    private void storeDataIntoAttribList(int attribNo, int vertexCount, float[] data){
        int vbo = GL15.glGenBuffers();
        vbos.add(vbo);
